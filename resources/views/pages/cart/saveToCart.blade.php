            ...
            <div>
               ...
               <table class="bang">
                ...
                @foreach ($Info as $key => $info)
                    <tr>
                        <td><a href="{{URL::to('ProductDetail/'.$info->ProductId)}}"><img width="100px" height="100" src="{{URL::to('Uploads/Products/'.$info->ProductImage)}}"></a></td>
                        <td>{{ $info->ProductName }}</td>
                        <td>{{ $info->ProductPrice." £"  }}</td>
                        <td>
                            <form action="{{URL::to('updateQuantity/'.$info->ProductId)}}" method="POST">
                                {{ csrf_field() }}
                                <a style="margin-right: 5px;" class="fa fa-minus" href="{{ URL::to('decreaseOneItem/'.$info->ProductId) }}"></a>
                                <span style="border: black solid 1px; padding: 3px 5px; border-radius: 2px;">{{ $info->Product_sale_quantity }}</span>
                                <input style="width: 10%;" type="hidden" name="ProductQuantity" min="1" max="10" value="{{ $info->Product_sale_quantity }}" />
                                <a style="margin-left: 5px;" class="fa fa-plus" href="{{ URL::to('increaseOneItems/'.$info->ProductId) }}"></a>
                            </form>
                        </td>
                        <td>
                            <?php
                        ...
                        <td><a style="font-size: 20px; padding: 5px;" class="fa fa-times" href="{{URL::to('deleteCartItems/'.$info->ProductId)}}"></a></td>
                    </tr>
                @endforeach
    ...
    function submit() {
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="shipping" id="">
                                        ...
                                        <option value="4">TP Da Nang</option>
                                        <option value="5">TP Cần Thơ</option>
                                    </select>
                                </td>
                        ...
                        <div style="float: right;">
                            <?php
                                ...
                                if($UserId != NULL) {
                                    ?>
                            <a><button type="submit">Xác nhận đơn hàng</button></a>
                            <?php
                                }else{
                                    ?>
                                <a href="{{URL::to('loginCheckOut')}}"><button type="submit">Xác nhận đơn hàng</button></a>
                                <?php
                                }
                                ?>
                        </div>
