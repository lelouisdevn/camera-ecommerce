                ...
                <div class="row" style="padding-top: 0; padding-bottom: 0;">
                    <div class="col-sm-4">
                        <div class="logo pull-left" style="margin-left:10px;">
                            <h3><a style="font-family: freemono; font-weight: bold; font-size: 27px;" href="{{URL::to('/')}}">Atlanteans</a></h3>
                        </div>
                    ...
                    <div class="col-sm-8" style="float: right;">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="{{URL::to('displayWishlist')}}"><i class="fa fa-heart"></i> Wishlist</a></li>
