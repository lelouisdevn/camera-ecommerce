      ...
      <div class="col-sm-3">
        <form action="{{ URL::to('searchOrder') }}" method="get">
          ...
          <div class="input-group">
            <input type="text" class="input-sm form-control" name="OrderId" placeholder="Tìm kiếm">
...
<script>
  function submit() {
            ...
            <td  style="width: 100px;">
              ...
              <div style="width: 100px; padding-left: 45px;" class="fa fa-print text-danger text f21"></div></a>
            </td>
          </tr>
          @endforeach()
        </tbody>
