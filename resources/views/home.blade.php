                    ...
                    <div class="col-sm-8" style="float: right;">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="#"><i class="fa fa-heart"></i> SP yêu thích</a></li>
...
<!-- <div style="margin: 0 33.4%;">
    <div style="margin-bottom: 45px;" class="brandnew">
        <a href="{{URL::to('Brand/16')}}"><span style="background: #1f203f; color: white;">Sony</span></a>
        <a href="{{URL::to('Brand/15')}}"><span style="background: #bf5973; color: white;">Nikon</span></a>
        <a href="{{URL::to('Brand/14')}}"><span style="background: #993dc2; color: white;">Canon</span></a>
        <a href="{{URL::to('Brand/13')}}"><span style="background: #f23b0d; color: white;">Leica</span></a>
        <a href="{{URL::to('Brand/17')}}"><span style="background: #ff1a80; color: white;">Olympus</span></a>
        <a href="{{URL::to('Brand/18')}}"><span style="background: #80bf59; color: white;">Fujifilm</span></a>
    </div>
</div> -->

    <div class="left">
        <div class="title" style="border-radius: 5px; width: 97%; margin: 0 20px 0 20px;">
            <center><h4 style="font-size:17px;">DANH MỤC SẢN PHẨM</h4></center>
        </div>
        <div class="center1">
            <h4 style="font-size:16px;">THƯƠNG HIỆU</h4>
            <ul style="border-bottom: grey solid 1px; width: 100%;">
            @foreach ( $Trademark as $key => $tr )
